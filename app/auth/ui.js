...
const signUpSuccess = (responseData) => {
	...
	$('#destinations-display').text('Signed up successfully!');
	//   removes all classes, then adds the green text success class
	// from bootstrap
	$('#destinations-display').removeClass();
...
const signUpFailure = (e) => {
	...
	$('#destinations-display').text('Signed up Failure!');
	//   removes all classes, then adds the red text success class
	// from bootstrap
	$('#destinations-display').removeClass();
	$('#destinations-display').addClass('text-danger');
...
const signInSuccess = (responseData) => {
	...
	// tell the user it was successful
	$('#destinations-display').text('Signed In successfully!');
	//   removes all classes, then adds the green text success class
	// from bootstrap
	$('#destinations-display').removeClass();
	$('#destinations-display').addClass('text-success');
...
const signInFailure = (e) => {
	// tell the user it was failure
	$('#destinations-display').text('Signed In Failure!');
	//   removes all classes, then adds the red text success class
	// from bootstrap
	$('#destinations-display').removeClass();
	$('#destinations-display').addClass('text-danger');
...
const changePasswordSuccess = (responseData) => {
	// tell the user it was successful
	$('#destinations-display').text('Changed Password successfully!');
	//   removes all classes, then adds the green text success class
	// from bootstrap
	$('#destinations-display').removeClass();
	$('#destinations-display').addClass('text-success');
...
const changePasswordFailure = (e) => {
	// tell the user it was failure
	$('#destinations-display').text('Changing Passwords Failed!');
	//   removes all classes, then adds the red text success class
	// from bootstrap
	$('#destinations-display').removeClass();
	$('#destinations-display').addClass('text-danger');
...
const signOutSuccess = (responseData) => {
	// tell the user it was successful
	$('#destinations-display').text('SignOut successfully!');
	//   removes all classes, then adds the green text success class
	// from bootstrap
	$('#destinations-display').removeClass();
	$('#destinations-display').addClass('text-success');
...
const signOutFailure = (e) => {
	// tell the user it was failure
	$('#destinations-display').text('SignOut Failed!');
	//   removes all classes, then adds the red text success class
	// from bootstrap
	$('#destinations-display').removeClass();
	$('#destinations-display').addClass('text-danger');
